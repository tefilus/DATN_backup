###########################################################################
## Makefile generated for component 'mcb_pmsm_foc_qep_dyno_f28069m'. 
## 
## Makefile     : mcb_pmsm_foc_qep_dyno_f28069m.mk
## Generated on : Wed Mar 12 09:45:13 2025
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/mcb_pmsm_foc_qep_dyno_f28069m.out
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/mcb_pmsm_foc_qep_dyno_f28069m.out
...
DEFINES_ = -DMW_SPI_A -DMW_SPISTE_SELECT_SPI_A -DMW_SPI_B -DMW_SPISTE_SELECT_SPI_B -D__MW_TARGET_USE_HARDWARE_RESOURCES_H__
...
DEFINES_SKIPFORSIL = -DMW_SCHEDULER_PRIORITY=2 -DXCP_CUSTOM_PLATFORM -DEXTMODE_DISABLE_ARGS_PROCESSING=1 -DMW_PIL_SCIFIFOLEN=4 -DMW_F2806X -DSTACK_SIZE=1024 -DRT -DF28069M -DCPU1 -DBOOT_FROM_FLASH=1 -DMW_FAST_RTS_INCLUDED=0 -DMW_HCCAL_INCLUDED=0
DEFINES_STANDARD = -DMODEL=mcb_pmsm_foc_qep_dyno_f28069m -DNUMST=3 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
%.obj : $(START_DIR)/mcb_pmsm_foc_qep_dyno_f28069m_ert_rtw/%.cla
	$(CC) $(CFLAGS) --output_file="$@" "$<"


%.obj : $(START_DIR)/mcb_pmsm_foc_qep_dyno_f28069m_ert_rtw/%.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


%.obj : $(START_DIR)/mcb_pmsm_foc_qep_dyno_f28069m_ert_rtw/%.asm
	$(AS) $(ASFLAGS) --output_file="$@" "$<"


%.obj : $(START_DIR)/mcb_pmsm_foc_qep_dyno_f28069m_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) --output_file="$@" "$<"
...
MW_c28xx_csl.obj : $(START_DIR)/mcb_pmsm_foc_qep_dyno_f28069m_ert_rtw/MW_c28xx_csl.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


MW_c28xx_board.obj : $(START_DIR)/mcb_pmsm_foc_qep_dyno_f28069m_ert_rtw/MW_c28xx_board.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


DSP28xx_SciUtil.obj : $(START_DIR)/mcb_pmsm_foc_qep_dyno_f28069m_ert_rtw/DSP28xx_SciUtil.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


MW_c28xx_adc.obj : $(START_DIR)/mcb_pmsm_foc_qep_dyno_f28069m_ert_rtw/MW_c28xx_adc.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


MW_c28xx_pwm.obj : $(START_DIR)/mcb_pmsm_foc_qep_dyno_f28069m_ert_rtw/MW_c28xx_pwm.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


MW_c28xx_qep.obj : $(START_DIR)/mcb_pmsm_foc_qep_dyno_f28069m_ert_rtw/MW_c28xx_qep.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


ert_main.obj : $(START_DIR)/mcb_pmsm_foc_qep_dyno_f28069m_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


mcb_pmsm_foc_qep_dyno_f28069m.obj : $(START_DIR)/mcb_pmsm_foc_qep_dyno_f28069m_ert_rtw/mcb_pmsm_foc_qep_dyno_f28069m.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


mcb_pmsm_foc_qep_dyno_f28069m_data.obj : $(START_DIR)/mcb_pmsm_foc_qep_dyno_f28069m_ert_rtw/mcb_pmsm_foc_qep_dyno_f28069m_data.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


rtGetInf.obj : $(START_DIR)/mcb_pmsm_foc_qep_dyno_f28069m_ert_rtw/rtGetInf.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


rtGetNaN.obj : $(START_DIR)/mcb_pmsm_foc_qep_dyno_f28069m_ert_rtw/rtGetNaN.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


rt_nonfinite.obj : $(START_DIR)/mcb_pmsm_foc_qep_dyno_f28069m_ert_rtw/rt_nonfinite.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"
